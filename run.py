...
class DeepfakeDetector(nn.Module):
    def __init__(self, nb_frames=10):
        ...
        self.convolution5 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=11, stride=1, padding=0)
        self.convolution6 = nn.Conv2d(in_channels=512, out_channels=512, kernel_size=11, stride=1, padding=0)
        self.dense = nn.Linear(131072,1)
